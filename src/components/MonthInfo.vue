<template>
  <h1 class="capitalize text-3xl font-serif text-teal-600 relative">
    {{ monthName(month) }} {{ year }}
    <span @click="setDate" class="absolute text-teal-600/50 hover:text-teal-600 transition-colors cursor-pointer">
